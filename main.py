...
st.write("Hi, my name is Biya and I am 13. I go to Boisevain school. I like playing video games and watching anime. I wanted to do AI Camp because it seemed interesting and I am into technology.") 
st.write("My name is Olivia and I am 15 years old. Some of my hobbies are hanging out with my friends and going out with family. I was interested in AI Camp because I've never coded before.")#put bios here
st.write("My name is Eden I'm currently going to 10th grade I had some prior experience in coding through designing a VR Map for a VR camp not that long ago.")
st.write("Hi! My name is Thomas and I am 22 years old. I am a mentor at AI Camp. In my free time, I play video games and work out.")
